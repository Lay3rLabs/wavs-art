        ...
        <div className="card relative">
            ...
            <div className="flex items-center justify-between mb-4 mt-8 font-mono text-xs border border-dark-700 bg-dark-900 p-2">
                <div className="text-primary">
                    MERKLE::<span className="text-accent">{merkleRoot ? merkleRoot.substring(0, 8) + '...' : 'NONE'}</span>
                </div>
                <div className="text-primary">
                    IPFS::<span className="text-warning">{currentIpfsHash ? currentIpfsHash.substring(0, 8) + '...' : 'NONE'}</span>
                </div>
                <div className="text-primary">
                    CLAIMED::<span className="text-secondary">{ethers.formatEther(claimedAmount)}</span>
                </div>
                <div className="text-primary">
                    ...
                    {!pendingReward ? (
                        ...
                        <div className="border border-dark-600 p-4 bg-dark-800">
                            ...
                            <button
                                ...
                                disabled={BigInt(pendingReward.claimable) <= BigInt(claimedAmount)}
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {rewardSources.map((source: RewardSource, index: number) => (
                                <div key={index} className="border border-dark-600 p-4 bg-dark-800">
                                    <div className="flex justify-between items-center mb-3">
                                        <h4 className="font-mono text-primary">
                                            {source.name === 'ERC721' ? 'NFT_HOLDINGS' : source.name}
                                        </h4>
                                        {source.balance && (
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="bg-dark-900 p-2 rounded">
                                                ...
                                                <div className="font-mono text-accent">
                                                    {ethers.formatEther(source.metadata.rewards_per_token)} tokens
                                                </div>
                                            </div>
                                        </div>
                                    )}
