...
function loadAndTransformEnv() {
  try {
    ...
    const transformedVars = {
      'VITE_MINTER_CONTRACT_ADDRESS': deployConfig.minter,
      'VITE_NFT_CONTRACT_ADDRESS': deployConfig.nft,
      'VITE_REWARD_DISTRIBUTOR_ADDRESS': deployConfig.reward_distributor,
      'VITE_REWARD_TOKEN_ADDRESS': deployConfig.reward_token,
      'VITE_IPFS_GATEWAY_URL': rootEnv.IPFS_GATEWAY_URL,
      'VITE_LOCALHOST': process.env.NODE_ENV === 'production' ? false : true,
    };
